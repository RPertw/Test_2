...
function uniq_setup() {
	...
	$starter_content = array( 
			...
			'footer-4' => array(
			    ...
			    'my_text' => array(
					...
					array(
					  ...
					  'text'  => '<div class="footer-contact"><p> <i class="fa fa-map-marker"></i> Po Box CT16122 Colin Street West, Australia </p><p><i class="fa fa-phone"></i> +123 456 7890</p><p><i class="fa fa-fax"></i> 03 5481 2221</p><p><i class="fa fa-envelope"></i> <a href="mailto:info@gmail.com">info@gmail.com</a></p></div>'
					)
				)
			),
		...
		'posts' => array(
	        ...
	        'post-two' => array(
	            'post_type' => 'post',
	            'post_title' => __( 'Post Two', 'uniq'),
	            'post_content' => sprintf( __('<h1> Slider Setting </h1><p>You haven\'t created any slider yet. Create a post, set your slider image as Post\'s featured image ( Recommended image size 1280*450 ) ). Go to Customizer and click uniq Options => Home and select Slider Post Category and No.of Sliders.<p><a href="%1$s"target="_blank"> Customizer </a></p>', 'uniq'),  admin_url('customize.php') ),
	            'thumbnail' => '{{post-featured-image}}',
	        ),  
			'service-one' => array(  
				'post_type' => 'page',
				'post_title' => __( 'Responsive Layout', 'uniq'),
	            'post_content' => sprintf( __('You haven\'t created any service page yet. Create Page. Go to <a href="%1$s"target="_blank"> Customizer </a> and click uniq Options => Home => Service Section #1 and select page from  dropdown page list.','uniq'), admin_url('customize.php') ),
				'thumbnail' => '{{page-images}}',
			),
			'service-two' => array(
				'post_type' => 'page',
				'post_title' => __( 'Awesome Slider', 'uniq'),
	            'post_content' => sprintf( __('You haven\'t created any service page yet. Create Page. Go to <a href="%1$s"target="_blank"> Customizer </a> and click uniq Options => Home => Service Section #1 and select page from  dropdown page list.','uniq'), admin_url('customize.php') ),
				'thumbnail' => '{{page-images}}',
			),
			'service-three' => array(
				'post_type' => 'page',
				'post_title' => __( 'Fully Customizable', 'uniq'),
	            'post_content' => sprintf( __('You haven\'t created any service page yet. Create Page. Go to <a href="%1$s"target="_blank"> Customizer </a> and click uniq Options => Home => Service Section #1 and select page from  dropdown page list.','uniq'), admin_url('customize.php') ),
				'thumbnail' => '{{page-images}}',
			),	*/		
		),
	...
	$starter_content = apply_filters( 'uniq_starter_content', $starter_content );
...
function uniq_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Sidebar Left', 'uniq' ),
		'id'            => 'sidebar-left',
		'description'   => __( 'Left Sidebar', 'uniq' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h4 class="widget-title">',
		'after_title'   => '</h4>',
...
function uniq_output_content_wrapper() {

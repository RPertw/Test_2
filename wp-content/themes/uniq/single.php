...
get_header(); get_template_part('breadcrumb'); ?>
	...
	<?php do_action('uniq_single_flexslider_featured_image'); ?>
...
<?php do_action('uniq_two_sidebar_left'); ?>	
    <div id="primary" class="content-area <?php uniq_layout_class();?> columns">
		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<?php do_action('uniq_after_single_content'); ?>

				<?php if( get_theme_mod ('social_sharing_box',true)): ?>
				<div class="share-box">
					<h4><?php _e( 'Share this on ...', 'uniq' ); ?></h4>
					<ul>
				...
				<section class="author-bio clearfix">
					<div class="author-info">
						...
						<div class="description">
							<h4><?php echo __( 'About Author:', 'uniq' ); ?> <?php the_author_posts_link(); ?></h4>
			...
			<?php if( get_theme_mod('related_posts') && function_exists( 'uniq_related_posts' ) ) : ?>
				<section class="related-posts clearfix">
					<?php uniq_related_posts(); ?>
				</section>
			<?php endif;  ?>
